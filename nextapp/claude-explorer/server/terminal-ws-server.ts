...
// TIOCSWINSZ ioctl number on Linux x86-64 (0x5414 = 21524)
...
function spawnPtyShell(
  ...
  // Close slave fd in parent — bash owns it now
  libc.symbols.close(slaveFd);

  // Read loop: PTY master → WebSocket
